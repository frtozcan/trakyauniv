...
model_path = yol + MODEL_NAME+"meg.h5"
csv_path = yol +MODEL_NAME+"meg.csv"
...
dataset_path = "E:/DATASETLER/meg_dataset/train/"
...
from datetime import datetime
model.save(yol+ MODEL_NAME+ datetime.now().strftime("%Y%m%d") + 'meg.hdf5')
...
strTemp = yol + MODEL_NAME + datetime.now().strftime("%Y%m%d") +  "_meg_history.h"
